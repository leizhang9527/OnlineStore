...
<head>
    ...
    .STYLE15 {color: #ffff00; font-size: 9pt; }
 </style>
...
<body>
	...
	<table width="559" height="423" border="0" align="center" cellpadding="0" cellspacing="0"  background="<%=path %>/images/dfff.jpg">
	 <tr>
	    <td><div align="center" style="FONT-WEIGHT: bold; FONT-SIZE: 40pt;">鲜花在线销售系统</div></td>
	 </tr>
	 <tr>
		<td width="559">
			<form  action="<%=path %>/userLogin.action" name="ThisForm" method="POST" action="">
				<table width="410" height="198" border="0" align="right" cellpadding="0" cellspacing="0">
					...
					<tr>
						<td height="10" colspan="2" valign="bottom"><br></td>
					</tr>
					<tr>
