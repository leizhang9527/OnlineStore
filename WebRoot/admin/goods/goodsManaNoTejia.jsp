...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
        ...
        <script language="javascript">
           ...
           //修改商品
           function goodsNoTejiaUpd(goodsId)
           {
               if(confirm('您确定修改吗？'))
               {
                   window.location.href="<%=path %>/goodsDetail4Upd.action?goodsId="+goodsId;
               }
           }
	...
	<body leftmargin="2" topmargin="2">
			<table width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA" align="center" style="margin-top:8px">
				<tr bgcolor="#E7E7E7">
					<td height="14" colspan="9">&nbsp;商品管理&nbsp;</td>
				</tr>
				...
				<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='red';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
					...
					<td bgcolor="#FFFFFF" align="center">
						<a href="#" onclick="goodsNoTejiaUpd(<s:property value="#goods.goodsId"/>)" class="pn-loperator">修改</a> &nbsp;
