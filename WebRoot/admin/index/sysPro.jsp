...
<%@ page import="cn.hutool.system.SystemUtil" %>
<%
...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body leftmargin="2" topmargin="9" background='<%=path %>/images/allbg.gif'>
	    <table width="98%" align="center" border="0" cellpadding="4" cellspacing="1" bgcolor="#CBD8AC" style="margin-bottom:8px">
		  ...
		  <tr bgcolor="#FFFFFF">
			<td width="25%" bgcolor="#FFFFFF" align="right">运行时信息：</td>
			<td>
				<b><%=SystemUtil.getRuntimeInfo()%></b>
			</td>
		  </tr>
			<tr bgcolor="#FFFFFF">
				<td width="25%" bgcolor="#FFFFFF" align="right">当前主机网络地址信息：</td>
				<td>
					<b><%=SystemUtil.getHostInfo()%></b>
				</td>
			</tr>
		</table>
	</body>
